<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
  ...
  <xsl:template match="atom:feed">
    ...
    <html xmlns="http://www.w3.org/1999/xhtml">
      ...
      <head>
        <meta charset="utf-8"/>
        <link rel="stylesheet" href="themes/planetgs/default.css" type="text/css" />
        ...
        <script defer="defer" src="themes/planetgs/personalize.js">
        ...
        <script type="text/javascript">
	  		...
	  		var _gaq = _gaq || [];
	  		_gaq.push(['_setAccount', 'UA-50306-2']);
...
<a href="http://www.spatiallyadjusted.com/planetgs/"><img src="http://images.spatiallyadjusted.com/PlanetGS-Appeal.jpg"></a>
          ...
          <dl>
            ...
            <dd>
              <a href="http://intertwingly.net/code/venus/">
                <img src="themes/planetgs/images/venus.png" width="80" height="15"
                  alt="Venus" border="0"/>
              </a>
            </dd>
            <dt>Export:</dt>
            <dd>
              <ul>
                <li>
                  <a href="opml.xml">
                    <img src="themes/planetgs/images/opml.png" alt="OPML"/>
                  </a>
                </li>
                <li>
                  <a href="foafroll.xml">
                    <img src="themes/planetgs/images/foaf.png" alt="FOAF"/>
                  </a>
                </li>
              </ul>
            </dd>
        ...
        <div id="footer">
          <h2>About</h2>
          <p>Planet Geospatial is a window into the world of geospatial technology. The list of contibutors changes over time.</p>
          <h2>Contact</h2>
            ...
            <xsl:for-each select="planet:source">
              ...
              <li>
                ...
                <a title="subscribe">
                  ...
                  <img src="themes/planetgs/images/feed-icon-10x10.png" alt="(feed)"/>
                </a>
                <xsl:text> </xsl:text>
